          ...
          <>
            <div style={{
              ...
              <button
                ...
                title="Flip"
                style={{ padding: '2px 8px', fontSize: '13px', fontWeight: 600, background: flipped ? '#d4a373' : '#fff', color: flipped ? '#fff' : '#8b5e3c', border: '1px solid #d4a373', borderRadius: '6px', cursor: 'pointer', lineHeight: 1.4 }}
              >↔</button>
